...
# в зависимости от выбранного персонажа возврщает сообщение о примении спец
# умения
...
# Позволяет игроку выбрать тип игрового персонажа и возвращает выбранный
# вариант
...
def main():  # Запуск игры и вызов вспомогательных функций
